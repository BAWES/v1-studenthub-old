            ...
            <div class="chat-window-wrapper scroller scrollbar-dynamic" id="chat-users" >
                ...
                <div class="side-widget fadeIn">
                   ...
                   <div id="favourites-list">
                    <div class="side-widget-content" >
                        <div class="user-details-wrapper active" data-chat-status="online" data-chat-user-pic="images/profiles/d.jpg" data-chat-user-pic-retina="images/profiles/d2x.jpg" data-user-name="Jane Smith">
                            <div class="user-profile">
                                <img src="images/profiles/d.jpg"  alt="" data-src="images/profiles/d.jpg" data-src-retina="images/profiles/d2x.jpg" width="35" height="35">
                            </div>
                            <div class="user-details">
                        ...
                        <div class="user-details-wrapper" data-chat-status="busy" data-chat-user-pic="images/profiles/d.jpg" data-chat-user-pic-retina="images/profiles/d2x.jpg" data-user-name="David Nester">
                            <div class="user-profile">
                                <img src="images/profiles/c.jpg"  alt="" data-src="images/profiles/c.jpg" data-src-retina="images/profiles/c2x.jpg" width="35" height="35">
                            </div>
                            <div class="user-details">
                                <div class="user-name">
                                David Nester
                ...
                <div class="side-widget">
                   <div class="side-widget-title">more friends</div>
                     <div class="side-widget-content" id="friends-list">
                        <div class="user-details-wrapper" data-chat-status="online" data-chat-user-pic="images/profiles/d.jpg" data-chat-user-pic-retina="images/profiles/d2x.jpg" data-user-name="Jane Smith">
                            <div class="user-profile">
                                <img src="images/profiles/d.jpg"  alt="" data-src="images/profiles/d.jpg" data-src-retina="images/profiles/d2x.jpg" width="35" height="35">
                            </div>
                            <div class="user-details">
