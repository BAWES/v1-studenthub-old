...
return [
    ...
    'in {delta, plural, =1{a day} other{# days}}' => 'بعد {delta, plural, =1{يوم} =2{يومين} other{# ايام}}',
    'in {delta, plural, =1{a minute} other{# minutes}}' => 'بعد {delta, plural, =1{دقيقة واحدة} =2{دقيقتين} other{# دقائق}}',
    'in {delta, plural, =1{a month} other{# months}}' => 'بعد {delta, plural, =1{شهر} =2{شهرين} other{# أشهر}}',
    'in {delta, plural, =1{a second} other{# seconds}}' => 'بعد {delta, plural, =1{ثانية واحدة} =2{ثانيتين} other{# ثوان}}',
    'in {delta, plural, =1{a year} other{# years}}' => 'بعد {delta, plural, =1{سنة} =2{سنتان} other{# سنوات}}',
    'in {delta, plural, =1{an hour} other{# hours}}' => 'بعد {delta, plural, =1{ساعة واحدة} =2{ساعتين} other{# ساعات}}',
    'just now' => 'للتو',
    '{delta, plural, =1{a day} other{# days}} ago' => 'قبل {delta, plural, =1{يوم} =2{يومين} other{# ايام}}',
    '{delta, plural, =1{a minute} other{# minutes}} ago' => 'قبل {delta, plural, =1{دقيقة واحدة} =2{دقيقتين} other{# دقائق}}',
    '{delta, plural, =1{a month} other{# months}} ago' => 'قبل {delta, plural, =1{شهر} =2{شهرين} other{# أشهر}}',
    '{delta, plural, =1{a second} other{# seconds}} ago' => 'قبل {delta, plural, =1{ثانية واحدة} =2{ثانيتين} other{# ثوان}}',
    '{delta, plural, =1{a year} other{# years}} ago' => 'قبل {delta, plural, =1{سنة} =2{سنتان} other{# سنوات}}',
    '{delta, plural, =1{an hour} other{# hours}} ago' => 'قبل {delta, plural, =1{ساعة واحدة} =2{ساعتين} other{# ساعات}}',
    '{nFormatted} B' => '',
    '{nFormatted} GB' => '',
    '{nFormatted} GiB' => '',
    '{nFormatted} KB' => '',
