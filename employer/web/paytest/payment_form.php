...
<form id="payment_form" action="payment_confirmation.php" method="post">
    ...
    <input type="hidden" name="bill_to_address_city" value="Kuwait">
    <input type="hidden" name="bill_to_address_country" value="KW">
    <input type="hidden" name="bill_to_address_line1" value="kaifan">
    <input type="hidden" name="bill_to_address_postal_code" value="XXXXX">
    <input type="hidden" name="bill_to_address_state" value="Kuwait">
    <input type="hidden" name="bill_to_email" value="test@yahoo.com">
    <input type="hidden" name="bill_to_forename" value="sahar">
    <input type="hidden" name="bill_to_phone" value="96512345678">
    <input type="hidden" name="bill_to_surname" value="Paul">
