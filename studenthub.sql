...
--
-- Host: localhost
-- Generation Time: Jul 14, 2015 at 09:42 PM
...
--
-- Table structure for table `cybersource_payment`
--

CREATE TABLE IF NOT EXISTS `cybersource_payment` (
  `payment_id` int(11) unsigned NOT NULL,
  `employer_id` int(11) unsigned NOT NULL,
  `job_id` int(11) unsigned DEFAULT NULL,
  `payment_track_uuid` varchar(128) NOT NULL DEFAULT '',
  `payment_first_name` varchar(128) DEFAULT '',
  `payment_last_name` varchar(128) DEFAULT '',
  ...
  `payment_decision` varchar(64) DEFAULT '',
  `payment_reason_code` varchar(64) DEFAULT '',
  `payment_auth_code` varchar(64) DEFAULT '',
  `payment_signature` varchar(128) NOT NULL DEFAULT '',
  `payment_datetime` datetime NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cybersource_payment`
--

INSERT INTO `cybersource_payment` (`payment_id`, `employer_id`, `job_id`, `payment_track_uuid`, `payment_first_name`, `payment_last_name`, `payment_email`, `payment_phone`, `payment_country`, `payment_card_type`, `payment_card_number`, `payment_card_expiry`, `payment_amount`, `payment_message`, `payment_decision`, `payment_reason_code`, `payment_auth_code`, `payment_signature`, `payment_datetime`) VALUES
(1, 1, NULL, '559d19ae3de7d', 'Khalid', 'Al-Mutawa', 'khalid@bawes.net', '99811042', '', '', '', '', 10.000, 'Payment Attempt', 'Payment Attempt', '', '', 'XkB7MPG9fvjOoJ3fnXjxK0hX0zRFHeFZoCn8uss79E8=', '2015-07-08 15:38:06'),
(2, 1, NULL, '559d19e1eb0a3', 'Khalid', 'Al-Mutawa', 'khalid@bawes.net', '99811042', '', '', '', '', 10.000, 'Payment Attempt', 'Payment Attempt', '', '', 'vrN5j+/Mrxp80/2w5cBypKcwZEhJZOP/BIBppBGUaZA=', '2015-07-08 15:38:57'),
(3, 1, NULL, '559d19fed1161', 'Khalid', 'Al-Mutawa', 'khalid@bawes.net', '99811042', '', '', '', '', 10.000, 'Payment Attempt', 'Payment Attempt', '', '', 'g6aVL4tHoZ247M6cs/C+0VmqxX0kZeZzqNeqp+d941Q=', '2015-07-08 15:39:26'),
(4, 1, NULL, '559d1c19edabe', 'Khalid', 'Al-Mutawa', 'khalid@bawes.net', '99811042', '', '', '', '', 10.000, 'Payment Attempt', 'Payment Attempt', '', '', 'boXMu4WLexfZkua9hgY5oyfv7stuUX6bKZjvQw5AI2o=', '2015-07-08 15:48:25'),
(5, 1, NULL, '559d1c4e6634c', 'Khalid', 'Al-Mutawa', 'khalid@bawes.net', '99811042', '', '', '', '', 10.000, 'Payment Attempt', 'Payment Attempt', '', '', '4cg2Albwv/sgWj6yMys9nYFIfzHOZbqBDeLDeCwG2NA=', '2015-07-08 15:49:18'),
(6, 1, NULL, '559d2dc43ad4a', 'Khalid', 'Al-Mutawa', 'khalid@bawes.net', '99811042', '', '', '', '', 10.000, 'Payment Attempt', 'Payment Attempt', '', '', 'ZuOcs8WRoXf7dqVlEZ8nmMZiL2Xu6wPq1+cxWU60EQE=', '2015-07-08 17:03:48'),
(7, 1, NULL, '559d2e5db9ef1', 'Test', 'Jamous', 'test@yahoo.com', '22111111', '', '', '', '', 10.000, 'Payment Attempt', 'Payment Attempt', '', '', 'Jz3VHlZkw5sW8EwY37+l8Sh72XCj0rkh+5bFbyCmz5Q=', '2015-07-08 17:06:21');
...
(1, 1, 4, 'BAWES', NULL, 'http://bawes.net', 'Develop awesome stuff\r\nThe best of the best\r\nWe are awesome', 3, 'Khalid', 'Al-Mutawa', '99811042', '14.000', 1, 'khalid@bawes.net', 1, 'AWLsiuInKDt_5Jz8ARA6c0q2dHX6-joB', '$2y$13$yD4XFIMwChLBjsRxTFQ5GuEvQTDIBtV8MCtouOC0rj4qhrNyyGvGa', NULL, 'en-US', '0', '2015-05-10 09:49:40', 'dwadawd', NULL, 'dwda', '2015-07-12 20:39:40', '2015-05-02 16:15:30'),
...
(14, NULL, '3.00', NULL, NULL, NULL, 1),
(15, NULL, '3.00', NULL, NULL, NULL, 0),
...
(11, 2, 1, 6, 'Project Tester', 1, NULL, 'dwadwa', 'yes no maybe3', 'dwadwg', 'No compensation', '', '', 10, 0, 1, '1.000', 0, '2015-07-06 20:50:10', '2015-05-21 08:26:37'),
(13, 1, 1, 7, 'dwa', 0, NULL, 'dwa', '', 'dwa', '', '', '', 10, 0, 2, '1.000', 0, '2015-07-06 20:51:10', '2015-05-27 19:41:41'),
(14, 3, 2, 7, 'Success Centre Attendant', 1, '2015-05-26', 'dwadwa', 'yes no maybe3', 'dwadwg', '', '', 'My Question', 66, 53, 1, '1.500', 1, '2015-06-24 11:50:23', '2015-05-21 08:26:37'),
(15, 2, 1, 6, 'Project Tester', 0, NULL, 'dwadwa', 'yes no maybe3', 'dwadwg', 'Chicken wings on the house', 'Do you have something?', 'Would you like to have one?', 80, 2, 1, '1.500', 0, '2015-05-31 08:14:00', '2015-05-21 08:26:37'),
(16, 5, 1, 8, 'dwad', 1, NULL, 'Hello', '', 'Yes', '', '', '', 10, 0, 2, '1.500', 0, '2015-07-06 20:52:36', '2015-05-27 17:30:06'),
(17, 1, 1, 9, 'Student', 1, NULL, 'dwa', '', 'dwa', '', '', '', 15, 12, 2, '1.250', 0, '2015-07-06 20:57:10', '2015-06-07 10:51:20'),
(18, 3, 1, 11, 'dwad', 1, NULL, 'dwa', '', 'dwa', '', '', '', 120, 0, 1, '0.750', 0, '2015-07-07 13:39:05', '2015-06-16 10:13:49'),
...
(22, 1, 1, 13, 'testdraft', 1, NULL, 'dwa', '', 'dwa', '', 'test', '', 15, 0, 0, '1.000', 0, '2015-06-30 14:58:14', '2015-06-30 14:57:28'),
(23, 1, 1, NULL, 'jhbn,', 1, NULL, 'nlk;', '', 'io', '', '', '', NULL, 0, 0, NULL, 0, '2015-07-06 20:37:18', '2015-07-06 20:37:16'),
(24, 3, 1, 14, 'Project Tester', 0, NULL, 'uhiojklm', '', 'njkml', '', '', '', 100, 0, 0, '1.750', 0, '2015-07-07 13:31:09', '2015-07-07 13:28:56'),
(25, 3, 1, 15, 'fre', 0, NULL, 'fre', '', 'fre', '', '', '', 10, 0, 0, '1.250', 0, '2015-07-08 15:01:34', '2015-07-08 14:59:44'),
(26, 1, 1, 16, 'sf', 1, NULL, 'efsef', '', 'dwa', '', '', '', 10, 0, 0, '0.750', 0, '2015-07-12 20:32:25', '2015-07-12 20:30:59');
...
(31, 11, '2015-07-06 20:50:10'),
(32, 13, '2015-07-06 20:50:40'),
(33, 16, '2015-07-06 20:52:21'),
(34, 17, '2015-07-06 20:56:48'),
(35, 18, '2015-07-07 13:39:05');
...
(224, 2, 'backend\\controllers\\JobController::actionForceClose', 1435135787.8017, '[::1][3][-]', '[Job Force Close] Job #14 force closed by Khalid'),
(225, 4, 'application', 1435135787.7651, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/force-close''\n    ''id'' => ''14''\n]\n\n$_COOKIE = [\n    ''PHPSESSID'' => ''m6e6k7vvdrmrlh04haukpqhrr1''\n    ''language'' => ''f256abca033839cb6fc2719c65848613815445e037b931cf57d5bc5d6462cd46a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''ull0p9m21l4nt17e4bs114vuf0''\n    ''app-employer'' => ''fq3p4a5cgi7is918rr6kc0psn1''\n    ''_csrf'' => ''ff58a6b51fe7f48d2e30e239e7145f7a21d63121b27c484f3a87321721a6198fa:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"cjtGYRIZsEfg1ajv54q2pXQYVm1UdM7j\\";}''\n    ''app-backend'' => ''euml711ego0lv2vccqhni04qt2''\n    ''_identity'' => ''a13d01d94d3d70974c6e2fe351496892d80dc4c867d0d4ac1de2d06606dde3bfa:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[3,\\"CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi\\",2592000]\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => [\n        ''success'' => -1\n    ]\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n    ''success'' => ''<h2 style=\\''margin:0;\\''>Job has been closed</h2>''\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=14''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''PHPSESSID=m6e6k7vvdrmrlh04haukpqhrr1; language=f256abca033839cb6fc2719c65848613815445e037b931cf57d5bc5d6462cd46a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=ull0p9m21l4nt17e4bs114vuf0; app-employer=fq3p4a5cgi7is918rr6kc0psn1; _csrf=ff58a6b51fe7f48d2e30e239e7145f7a21d63121b27c484f3a87321721a6198fa%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22cjtGYRIZsEfg1ajv54q2pXQYVm1UdM7j%22%3B%7D; app-backend=euml711ego0lv2vccqhni04qt2; _identity=a13d01d94d3d70974c6e2fe351496892d80dc4c867d0d4ac1de2d06606dde3bfa%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B3%2C%22CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi%22%2C2592000%5D%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.10''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''49808''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fforce-close&id=14''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fforce-close&id=14''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1435135787.763\n    ''REQUEST_TIME'' => 1435135787\n]'),
(226, 1, 'backend\\controllers\\JobController::actionForceClose', 1435135823.4426, '[::1][3][-]', '[Job Force Close] Job #14 force closed by Khalid'),
(227, 4, 'application', 1435135823.4091, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/force-close''\n    ''id'' => ''14''\n]\n\n$_COOKIE = [\n    ''PHPSESSID'' => ''m6e6k7vvdrmrlh04haukpqhrr1''\n    ''language'' => ''f256abca033839cb6fc2719c65848613815445e037b931cf57d5bc5d6462cd46a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''ull0p9m21l4nt17e4bs114vuf0''\n    ''app-employer'' => ''fq3p4a5cgi7is918rr6kc0psn1''\n    ''_csrf'' => ''ff58a6b51fe7f48d2e30e239e7145f7a21d63121b27c484f3a87321721a6198fa:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"cjtGYRIZsEfg1ajv54q2pXQYVm1UdM7j\\";}''\n    ''app-backend'' => ''euml711ego0lv2vccqhni04qt2''\n    ''_identity'' => ''a13d01d94d3d70974c6e2fe351496892d80dc4c867d0d4ac1de2d06606dde3bfa:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[3,\\"CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi\\",2592000]\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => [\n        ''success'' => -1\n    ]\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n    ''success'' => ''<h2 style=\\''margin:0;\\''>Job has been closed</h2>''\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=14''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''PHPSESSID=m6e6k7vvdrmrlh04haukpqhrr1; language=f256abca033839cb6fc2719c65848613815445e037b931cf57d5bc5d6462cd46a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=ull0p9m21l4nt17e4bs114vuf0; app-employer=fq3p4a5cgi7is918rr6kc0psn1; _csrf=ff58a6b51fe7f48d2e30e239e7145f7a21d63121b27c484f3a87321721a6198fa%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22cjtGYRIZsEfg1ajv54q2pXQYVm1UdM7j%22%3B%7D; app-backend=euml711ego0lv2vccqhni04qt2; _identity=a13d01d94d3d70974c6e2fe351496892d80dc4c867d0d4ac1de2d06606dde3bfa%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B3%2C%22CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi%22%2C2592000%5D%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.10''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''49816''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fforce-close&id=14''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fforce-close&id=14''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1435135823.407\n    ''REQUEST_TIME'' => 1435135823\n]'),
(228, 4, 'common\\models\\Student::beforeSave', 1435494388.7249, '[::1][-][-]', 'New student signup - Khalid Mutawa'),
(229, 4, 'application', 1435494387.3326, '[::1][-][-]', '$_GET = [\n    ''r'' => ''register/validate''\n]\n\n$_POST = [\n    ''student_email_preference'' => ''2''\n    ''student_firstname'' => ''Khalid''\n    ''student_lastname'' => ''Mutawa''\n    ''student_dob'' => ''1986/06/11''\n    ''country_id'' => ''5''\n    ''student_status'' => ''0''\n    ''degree_id'' => ''2''\n    ''student_enrolment_year'' => ''2013''\n    ''student_graduating_year'' => ''2017''\n    ''majorsSelected'' => [\n        0 => ''339''\n    ]\n    ''student_gpa'' => ''3''\n    ''student_gender'' => ''1''\n    ''languagesSelected'' => [\n        0 => ''2''\n        1 => ''3''\n        2 => ''4''\n    ]\n    ''student_english_level'' => ''2''\n    ''student_transportation'' => ''1''\n    ''student_club'' => ''''\n    ''student_sport'' => ''''\n    ''student_experience_company'' => ''''\n    ''student_experience_position'' => ''''\n    ''student_skill'' => ''''\n    ''student_hobby'' => ''''\n    ''student_interestingfacts'' => ''''\n    ''student_photo'' => ''''\n    ''student_cv'' => ''''\n    ''step'' => ''2''\n    ''university_id'' => ''2''\n    ''student_email'' => ''dwadwad@dwad.com''\n    ''student_password_hash'' => ''dwadwad''\n    ''student_contact_number'' => ''99811042''\n    ''student_verification_attachment'' => ''2HLMXQHbHxnCpo7gFfnJLS5OQ--QAPpQ.jpg''\n]\n\n$_COOKIE = [\n    ''PHPSESSID'' => ''m6e6k7vvdrmrlh04haukpqhrr1''\n    ''app-backend'' => ''euml711ego0lv2vccqhni04qt2''\n    ''language'' => ''f256abca033839cb6fc2719c65848613815445e037b931cf57d5bc5d6462cd46a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-employer'' => ''fq3p4a5cgi7is918rr6kc0psn1''\n    ''_csrf'' => ''21374fc961774c92beaf8e89971620bfff777ffb27af215e6ad89ad09e78497fa:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"GLo2EkCuvOcL4Rlea-k9pHhiZNCRsb3g\\";}''\n    ''_gat'' => ''1''\n    ''_ga'' => ''GA1.1.1937906258.1435480405''\n    ''app-frontend'' => ''21o8l2i8ak8hiklssk8c6rgoq0''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''CONTENT_LENGTH'' => ''740''\n    ''HTTP_ACCEPT'' => ''*/*''\n    ''HTTP_ORIGIN'' => ''http://localhost''\n    ''HTTP_X_CSRF_TOKEN'' => ''VGZVSk1QX0kTKjp4CDscPCIpNgZ5AjMsNUs.cz0YNyAOKBYYPjJsLg==''\n    ''HTTP_X_REQUESTED_WITH'' => ''XMLHttpRequest''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''CONTENT_TYPE'' => ''application/x-www-form-urlencoded; charset=UTF-8''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/frontend/web/index.php?r=register%2Fregister&university=2''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''PHPSESSID=m6e6k7vvdrmrlh04haukpqhrr1; app-backend=euml711ego0lv2vccqhni04qt2; language=f256abca033839cb6fc2719c65848613815445e037b931cf57d5bc5d6462cd46a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-employer=fq3p4a5cgi7is918rr6kc0psn1; _csrf=21374fc961774c92beaf8e89971620bfff777ffb27af215e6ad89ad09e78497fa%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22GLo2EkCuvOcL4Rlea-k9pHhiZNCRsb3g%22%3B%7D; _gat=1; _ga=GA1.1.1937906258.1435480405; app-frontend=21o8l2i8ak8hiklssk8c6rgoq0''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.10''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/frontend/web/index.php''\n    ''REMOTE_PORT'' => ''55964''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''POST''\n    ''QUERY_STRING'' => ''r=register%2Fvalidate''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/frontend/web/index.php?r=register%2Fvalidate''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/frontend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/frontend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1435494387.33\n    ''REQUEST_TIME'' => 1435494387\n]'),
(230, 1, 'common\\models\\CybersourcePayment::__construct', 1435829497.802, '[::1][1][-]', 'Array\n(\n    [payment_datetime] => Array\n        (\n            [0] => Payment Datetime لا يمكن تركه فارغًا.\n        )\n\n)\n'),
(231, 4, 'application', 1435829497.7766, '[::1][1][-]', '$_GET = [\n    ''r'' => ''cybersource/pay''\n]\n\n$_COOKIE = [\n    ''PHPSESSID'' => ''m6e6k7vvdrmrlh04haukpqhrr1''\n    ''app-frontend'' => ''c14gblmlks6k9v7gcmns9r31k2''\n    ''app-backend'' => ''68as2neeh4u0vk90prfhs0gqk0''\n    ''_csrf'' => ''2e2e13c3800a4b5f02c08717e88f14db4fcc27765ae066767f2556efed0a158ba:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"1xmejTkrQmAzX3MfIm3Oy06rQIs07a5t\\";}''\n    ''language'' => ''1bc24752ec1fcdf853bd5fbedd2dfd89076053b2292386de10c41926165bfadba:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"ar-KW\\";}''\n    ''app-employer'' => ''rd4acf3349qbak9ct6okb1qp73''\n    ''_gat'' => ''1''\n    ''_identity'' => ''9f72bbe0e3da1880993af25cdab363df09b4f2f0a24ed12f4c697e750ae179c0a:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[1,\\"AWLsiuInKDt_5Jz8ARA6c0q2dHX6-joB\\",2592000]\\";}''\n    ''_ga'' => ''GA1.1.1937906258.1435480405''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__id'' => 1\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_CACHE_CONTROL'' => ''max-age=0''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''PHPSESSID=m6e6k7vvdrmrlh04haukpqhrr1; app-frontend=c14gblmlks6k9v7gcmns9r31k2; app-backend=68as2neeh4u0vk90prfhs0gqk0; _csrf=2e2e13c3800a4b5f02c08717e88f14db4fcc27765ae066767f2556efed0a158ba%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%221xmejTkrQmAzX3MfIm3Oy06rQIs07a5t%22%3B%7D; language=1bc24752ec1fcdf853bd5fbedd2dfd89076053b2292386de10c41926165bfadba%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22ar-KW%22%3B%7D; app-employer=rd4acf3349qbak9ct6okb1qp73; _gat=1; _identity=9f72bbe0e3da1880993af25cdab363df09b4f2f0a24ed12f4c697e750ae179c0a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B1%2C%22AWLsiuInKDt_5Jz8ARA6c0q2dHX6-joB%22%2C2592000%5D%22%3B%7D; _ga=GA1.1.1937906258.1435480405''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.10''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/employer/web/index.php''\n    ''REMOTE_PORT'' => ''49649''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=cybersource/pay''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/employer/web/index.php?r=cybersource/pay''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/employer/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/employer/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1435829497.774\n    ''REQUEST_TIME'' => 1435829497\n]'),
(232, 1, 'common\\models\\CybersourcePayment::__construct', 1435829511.764, '[::1][1][-]', 'Array\n(\n    [payment_datetime] => Array\n        (\n            [0] => Payment Datetime cannot be blank.\n        )\n\n)\n'),
(233, 4, 'application', 1435829511.7415, '[::1][1][-]', '$_GET = [\n    ''r'' => ''cybersource/pay''\n]\n\n$_COOKIE = [\n    ''PHPSESSID'' => ''m6e6k7vvdrmrlh04haukpqhrr1''\n    ''app-frontend'' => ''c14gblmlks6k9v7gcmns9r31k2''\n    ''app-backend'' => ''68as2neeh4u0vk90prfhs0gqk0''\n    ''_gat'' => ''1''\n    ''_ga'' => ''GA1.1.1937906258.1435480405''\n    ''_csrf'' => ''a6d4dd58e06ae20224525095d18f4cfc5484c81d8f6e9d437db1e8ecbf37ba60a:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"bPUbyxPQp3x98O8bz1llTcooeW9kv2uF\\";}''\n    ''language'' => ''f256abca033839cb6fc2719c65848613815445e037b931cf57d5bc5d6462cd46a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''_identity'' => ''9f72bbe0e3da1880993af25cdab363df09b4f2f0a24ed12f4c697e750ae179c0a:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[1,\\"AWLsiuInKDt_5Jz8ARA6c0q2dHX6-joB\\",2592000]\\";}''\n    ''app-employer'' => ''rd4acf3349qbak9ct6okb1qp73''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__id'' => 1\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/employer/web/index.php?r=cybersource/pay''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''PHPSESSID=m6e6k7vvdrmrlh04haukpqhrr1; app-frontend=c14gblmlks6k9v7gcmns9r31k2; app-backend=68as2neeh4u0vk90prfhs0gqk0; _gat=1; _ga=GA1.1.1937906258.1435480405; _csrf=a6d4dd58e06ae20224525095d18f4cfc5484c81d8f6e9d437db1e8ecbf37ba60a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22bPUbyxPQp3x98O8bz1llTcooeW9kv2uF%22%3B%7D; language=f256abca033839cb6fc2719c65848613815445e037b931cf57d5bc5d6462cd46a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; _identity=9f72bbe0e3da1880993af25cdab363df09b4f2f0a24ed12f4c697e750ae179c0a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B1%2C%22AWLsiuInKDt_5Jz8ARA6c0q2dHX6-joB%22%2C2592000%5D%22%3B%7D; app-employer=rd4acf3349qbak9ct6okb1qp73''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.10''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/employer/web/index.php''\n    ''REMOTE_PORT'' => ''49663''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=cybersource/pay''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/employer/web/index.php?r=cybersource/pay''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/employer/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/employer/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1435829511.74\n    ''REQUEST_TIME'' => 1435829511\n]'),
(234, 4, 'backend\\models\\Job::verify', 1436205010.3743, '[::1][3][-]', '[Job #11] has been added to broadcasting queue'),
(235, 4, 'backend\\models\\Job::verify', 1436205010.3749, '[::1][3][-]', '[Job #11] has been approved by Khalid'),
(236, 4, 'application', 1436205010.3358, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/verify''\n    ''id'' => ''11''\n]\n\n$_COOKIE = [\n    ''language'' => ''f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''amml36kjna9djscjca1cefpk74''\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_gat'' => ''1''\n    ''_csrf'' => ''5ed2bc4d49bd3cfef6b0114e43585851ef9332e7c8fa3a1d19a27cab9085596da:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"ApVSdyxQi1oSUctEa35MJRB1n20tO9iG\\";}''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''_identity'' => ''cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[3,\\"CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi\\",2592000]\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=11''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''language=f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=amml36kjna9djscjca1cefpk74; app-employer=r14018bhhobgcup79i8toe9v11; _ga=GA1.1.1762749747.1435241427; _gat=1; _csrf=5ed2bc4d49bd3cfef6b0114e43585851ef9332e7c8fa3a1d19a27cab9085596da%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22ApVSdyxQi1oSUctEa35MJRB1n20tO9iG%22%3B%7D; app-backend=jv28k5vj2l9n6osivfdcr3qtu2; _identity=cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B3%2C%22CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi%22%2C2592000%5D%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''55996''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fverify&id=11''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fverify&id=11''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436205010.333\n    ''REQUEST_TIME'' => 1436205010\n]'),
(237, 4, 'backend\\models\\Job::verify', 1436205040.8181, '[::1][3][-]', '[Job #13] has been added to broadcasting queue'),
(238, 4, 'backend\\models\\Job::verify', 1436205040.8186, '[::1][3][-]', '[Job #13] has been approved by Khalid'),
(239, 4, 'application', 1436205040.7826, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/verify''\n    ''id'' => ''13''\n]\n\n$_COOKIE = [\n    ''language'' => ''f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''amml36kjna9djscjca1cefpk74''\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_gat'' => ''1''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''_identity'' => ''cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[3,\\"CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi\\",2592000]\\";}''\n    ''_csrf'' => ''53c878842e0c8616e75317cb1c552f5e758148e37f41b440f0d6027e4646ce5da:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"SMJej1Sw2cgJd7cFAekHcjJvu5vgT6z7\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=13''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''language=f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=amml36kjna9djscjca1cefpk74; app-employer=r14018bhhobgcup79i8toe9v11; _ga=GA1.1.1762749747.1435241427; _gat=1; app-backend=jv28k5vj2l9n6osivfdcr3qtu2; _identity=cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B3%2C%22CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi%22%2C2592000%5D%22%3B%7D; _csrf=53c878842e0c8616e75317cb1c552f5e758148e37f41b440f0d6027e4646ce5da%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22SMJej1Sw2cgJd7cFAekHcjJvu5vgT6z7%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56007''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fverify&id=13''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fverify&id=13''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436205040.779\n    ''REQUEST_TIME'' => 1436205040\n]'),
(240, 1, 'backend\\controllers\\JobController::actionForceClose', 1436205070.8689, '[::1][3][-]', '[Job Force Close] Job #13 force closed by Khalid'),
(241, 4, 'application', 1436205070.8356, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/force-close''\n    ''id'' => ''13''\n]\n\n$_COOKIE = [\n    ''language'' => ''f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''amml36kjna9djscjca1cefpk74''\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_gat'' => ''1''\n    ''_identity'' => ''cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[3,\\"CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi\\",2592000]\\";}''\n    ''_csrf'' => ''53c878842e0c8616e75317cb1c552f5e758148e37f41b440f0d6027e4646ce5da:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"SMJej1Sw2cgJd7cFAekHcjJvu5vgT6z7\\";}''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n]\n\n$_SESSION = [\n    ''__flash'' => [\n        ''success'' => -1\n    ]\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n    ''success'' => ''<h2 style=\\''margin:0;\\''>Job has been closed</h2>''\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=13''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''language=f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=amml36kjna9djscjca1cefpk74; app-employer=r14018bhhobgcup79i8toe9v11; _ga=GA1.1.1762749747.1435241427; _gat=1; _identity=cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B3%2C%22CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi%22%2C2592000%5D%22%3B%7D; _csrf=53c878842e0c8616e75317cb1c552f5e758148e37f41b440f0d6027e4646ce5da%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22SMJej1Sw2cgJd7cFAekHcjJvu5vgT6z7%22%3B%7D; app-backend=jv28k5vj2l9n6osivfdcr3qtu2''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56028''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fforce-close&id=13''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fforce-close&id=13''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436205070.833\n    ''REQUEST_TIME'' => 1436205070\n]'),
(242, 4, 'backend\\models\\Job::verify', 1436205141.8527, '[::1][3][-]', '[Job #16] has been added to broadcasting queue'),
(243, 4, 'backend\\models\\Job::verify', 1436205141.8533, '[::1][3][-]', '[Job #16] has been approved by Khalid'),
(244, 4, 'application', 1436205141.8154, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/verify''\n    ''id'' => ''16''\n]\n\n$_COOKIE = [\n    ''language'' => ''f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''amml36kjna9djscjca1cefpk74''\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_gat'' => ''1''\n    ''_identity'' => ''cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[3,\\"CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi\\",2592000]\\";}''\n    ''_csrf'' => ''53c878842e0c8616e75317cb1c552f5e758148e37f41b440f0d6027e4646ce5da:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"SMJej1Sw2cgJd7cFAekHcjJvu5vgT6z7\\";}''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=16''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''language=f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=amml36kjna9djscjca1cefpk74; app-employer=r14018bhhobgcup79i8toe9v11; _ga=GA1.1.1762749747.1435241427; _gat=1; _identity=cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B3%2C%22CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi%22%2C2592000%5D%22%3B%7D; _csrf=53c878842e0c8616e75317cb1c552f5e758148e37f41b440f0d6027e4646ce5da%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22SMJej1Sw2cgJd7cFAekHcjJvu5vgT6z7%22%3B%7D; app-backend=jv28k5vj2l9n6osivfdcr3qtu2''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56043''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fverify&id=16''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fverify&id=16''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436205141.813\n    ''REQUEST_TIME'' => 1436205141\n]'),
(245, 1, 'backend\\controllers\\JobController::actionForceClose', 1436205156.012, '[::1][3][-]', '[Job Force Close] Job #16 force closed by Khalid'),
(246, 4, 'application', 1436205155.9771, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/force-close''\n    ''id'' => ''16''\n]\n\n$_COOKIE = [\n    ''language'' => ''f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''amml36kjna9djscjca1cefpk74''\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_gat'' => ''1''\n    ''_identity'' => ''cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[3,\\"CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi\\",2592000]\\";}''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''_csrf'' => ''64a8687eeff711bd252eb38b6af46c65e913478950b63bd7352567c78a114718a:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"eUm-xGchEuzCYOy3iHISfBAChwcYgbk6\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => [\n        ''success'' => -1\n    ]\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n    ''success'' => ''<h2 style=\\''margin:0;\\''>Job has been closed</h2>''\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=16''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''language=f8500d39c1d102d396f79f7340e851e9ecf2104e6c0f97d41d2b93a68f71d78ca%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=amml36kjna9djscjca1cefpk74; app-employer=r14018bhhobgcup79i8toe9v11; _ga=GA1.1.1762749747.1435241427; _gat=1; _identity=cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B3%2C%22CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi%22%2C2592000%5D%22%3B%7D; app-backend=jv28k5vj2l9n6osivfdcr3qtu2; _csrf=64a8687eeff711bd252eb38b6af46c65e913478950b63bd7352567c78a114718a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22eUm-xGchEuzCYOy3iHISfBAChwcYgbk6%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56050''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fforce-close&id=16''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fforce-close&id=16''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436205155.974\n    ''REQUEST_TIME'' => 1436205155\n]'),
(247, 4, 'backend\\models\\Job::verify', 1436205408.4906, '[::1][3][-]', '[Job #17] has been added to broadcasting queue'),
(248, 4, 'backend\\models\\Job::verify', 1436205408.4911, '[::1][3][-]', '[Job #17] has been approved by Khalid'),
(249, 4, 'application', 1436205408.4532, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/verify''\n    ''id'' => ''17''\n]\n\n$_COOKIE = [\n    ''app-frontend'' => ''amml36kjna9djscjca1cefpk74''\n    ''_gat'' => ''1''\n    ''_identity'' => ''cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[3,\\"CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi\\",2592000]\\";}''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''language'' => ''425539a63df9f9119aebc8b2d243b410acc134b12f3fb0ba54b625c6183dcf07a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"ar-KW\\";}''\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_csrf'' => ''62a7b7d42332584e5bc79a63e167bc256eadd2a514e7447d12e7b181e769c601a:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"-2k5S5a6KzsQMfrQXV_KvY4nZnp2TmUt\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=17''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''app-frontend=amml36kjna9djscjca1cefpk74; _gat=1; _identity=cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B3%2C%22CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi%22%2C2592000%5D%22%3B%7D; app-backend=jv28k5vj2l9n6osivfdcr3qtu2; language=425539a63df9f9119aebc8b2d243b410acc134b12f3fb0ba54b625c6183dcf07a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22ar-KW%22%3B%7D; app-employer=r14018bhhobgcup79i8toe9v11; _ga=GA1.1.1762749747.1435241427; _csrf=62a7b7d42332584e5bc79a63e167bc256eadd2a514e7447d12e7b181e769c601a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22-2k5S5a6KzsQMfrQXV_KvY4nZnp2TmUt%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56132''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fverify&id=17''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fverify&id=17''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436205408.45\n    ''REQUEST_TIME'' => 1436205408\n]'),
(250, 1, 'backend\\controllers\\JobController::actionForceClose', 1436205430.1112, '[::1][3][-]', '[Job Force Close] Job #17 force closed by Khalid');
INSERT INTO `log` (`id`, `level`, `category`, `log_time`, `prefix`, `message`) VALUES
(251, 4, 'application', 1436205430.0779, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/force-close''\n    ''id'' => ''17''\n]\n\n$_COOKIE = [\n    ''app-frontend'' => ''amml36kjna9djscjca1cefpk74''\n    ''_gat'' => ''1''\n    ''_identity'' => ''cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[3,\\"CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi\\",2592000]\\";}''\n    ''language'' => ''425539a63df9f9119aebc8b2d243b410acc134b12f3fb0ba54b625c6183dcf07a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"ar-KW\\";}''\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_csrf'' => ''62a7b7d42332584e5bc79a63e167bc256eadd2a514e7447d12e7b181e769c601a:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"-2k5S5a6KzsQMfrQXV_KvY4nZnp2TmUt\\";}''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n]\n\n$_SESSION = [\n    ''__flash'' => [\n        ''success'' => -1\n    ]\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n    ''success'' => ''<h2 style=\\''margin:0;\\''>Job has been closed</h2>''\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=17''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''app-frontend=amml36kjna9djscjca1cefpk74; _gat=1; _identity=cc3350a1f77d354e8b31c627651f8a91855369bc5483bd448aeb6f565e388ae2a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B3%2C%22CT7I0NqtWqYJD1idnQbf1ErsCf_IEfHi%22%2C2592000%5D%22%3B%7D; language=425539a63df9f9119aebc8b2d243b410acc134b12f3fb0ba54b625c6183dcf07a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22ar-KW%22%3B%7D; app-employer=r14018bhhobgcup79i8toe9v11; _ga=GA1.1.1762749747.1435241427; _csrf=62a7b7d42332584e5bc79a63e167bc256eadd2a514e7447d12e7b181e769c601a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22-2k5S5a6KzsQMfrQXV_KvY4nZnp2TmUt%22%3B%7D; app-backend=jv28k5vj2l9n6osivfdcr3qtu2''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56143''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fforce-close&id=17''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fforce-close&id=17''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436205430.075\n    ''REQUEST_TIME'' => 1436205430\n]'),
(252, 4, 'backend\\models\\VerifyIdForm::verifyIdentity', 1436207025.2788, '[::1][3][-]', '[Student #13] had his identity verified by Khalid'),
(253, 4, 'application', 1436207025.24, '[::1][3][-]', '$_GET = [\n    ''r'' => ''student/view''\n    ''id'' => ''13''\n]\n\n$_POST = [\n    ''_csrf'' => ''OEJuQ1MuRnddJRkVMVgEI3NwBxtqXTMUTiwCCxV0FAVnEQImGHoUBA==''\n    ''VerifyIdForm'' => [\n        ''idNumber'' => ''123''\n    ]\n]\n\n$_COOKIE = [\n    ''language'' => ''425539a63df9f9119aebc8b2d243b410acc134b12f3fb0ba54b625c6183dcf07a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"ar-KW\\";}''\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''_gat'' => ''1''\n    ''app-frontend'' => ''tkc220khtejs5uil356k4f93n3''\n    ''_identity'' => ''3842c793553cd934eabd6c453be6f134383f81983bfa5833f6d0cfef514823a0a:2:{i:0;s:9:\\"_identity\\";i:1;s:47:\\"[13,\\"V0nH70XkhjxuBSP3k4Mi-Rq5c_Lj6bvc\\",2592000]\\";}''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_csrf'' => ''46c6a12f95f38c1cc16aaaee4f8b38fda6f3b23134bcc0cbcd228d068cc6e945a:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"egwVbvBTK2iX9sucvnlHFZRr_SleKTRs\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''CONTENT_LENGTH'' => ''97''\n    ''HTTP_CACHE_CONTROL'' => ''max-age=0''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_ORIGIN'' => ''http://localhost''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''CONTENT_TYPE'' => ''application/x-www-form-urlencoded''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''language=425539a63df9f9119aebc8b2d243b410acc134b12f3fb0ba54b625c6183dcf07a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22ar-KW%22%3B%7D; app-employer=r14018bhhobgcup79i8toe9v11; app-backend=jv28k5vj2l9n6osivfdcr3qtu2; _gat=1; app-frontend=tkc220khtejs5uil356k4f93n3; _identity=3842c793553cd934eabd6c453be6f134383f81983bfa5833f6d0cfef514823a0a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A47%3A%22%5B13%2C%22V0nH70XkhjxuBSP3k4Mi-Rq5c_Lj6bvc%22%2C2592000%5D%22%3B%7D; _ga=GA1.1.1762749747.1435241427; _csrf=46c6a12f95f38c1cc16aaaee4f8b38fda6f3b23134bcc0cbcd228d068cc6e945a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22egwVbvBTK2iX9sucvnlHFZRr_SleKTRs%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56364''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''POST''\n    ''QUERY_STRING'' => ''r=student%2Fview&id=13''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436207025.237\n    ''REQUEST_TIME'' => 1436207025\n]'),
(254, 4, 'backend\\models\\VerifyIdForm::verifyIdentity', 1436207309.9126, '[::1][3][-]', '[Student #13] had his identity verified by Khalid'),
(255, 4, 'application', 1436207309.8795, '[::1][3][-]', '$_GET = [\n    ''r'' => ''student/view''\n    ''id'' => ''13''\n]\n\n$_POST = [\n    ''_csrf'' => ''czNqRVB3QXgcdy0qAlp3AgMBLSMnOS08H1cAPRkzNCxCHgMKZwIZIg==''\n    ''VerifyIdForm'' => [\n        ''idNumber'' => ''321''\n    ]\n]\n\n$_COOKIE = [\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''language'' => ''b1a555c53ad9ee1d64515ae19576c71b099a8f68599514c999d8f2ff84692823a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"ar-KW\\";}''\n    ''app-frontend'' => ''tkc220khtejs5uil356k4f93n3''\n    ''_identity'' => ''3842c793553cd934eabd6c453be6f134383f81983bfa5833f6d0cfef514823a0a:2:{i:0;s:9:\\"_identity\\";i:1;s:47:\\"[13,\\"V0nH70XkhjxuBSP3k4Mi-Rq5c_Lj6bvc\\",2592000]\\";}''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_csrf'' => ''db5003df27f082e062eb7cc7244a2db9ffc9cfda3be49b22fe11b371e63091c1a:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"oDGoR-6zp2GfwNlDldjxIDuT1-iO7uXZ\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''CONTENT_LENGTH'' => ''97''\n    ''HTTP_CACHE_CONTROL'' => ''max-age=0''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_ORIGIN'' => ''http://localhost''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''CONTENT_TYPE'' => ''application/x-www-form-urlencoded''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''app-employer=r14018bhhobgcup79i8toe9v11; app-backend=jv28k5vj2l9n6osivfdcr3qtu2; language=b1a555c53ad9ee1d64515ae19576c71b099a8f68599514c999d8f2ff84692823a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22ar-KW%22%3B%7D; app-frontend=tkc220khtejs5uil356k4f93n3; _identity=3842c793553cd934eabd6c453be6f134383f81983bfa5833f6d0cfef514823a0a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A47%3A%22%5B13%2C%22V0nH70XkhjxuBSP3k4Mi-Rq5c_Lj6bvc%22%2C2592000%5D%22%3B%7D; _ga=GA1.1.1762749747.1435241427; _csrf=db5003df27f082e062eb7cc7244a2db9ffc9cfda3be49b22fe11b371e63091c1a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22oDGoR-6zp2GfwNlDldjxIDuT1-iO7uXZ%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56438''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''POST''\n    ''QUERY_STRING'' => ''r=student%2Fview&id=13''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436207309.877\n    ''REQUEST_TIME'' => 1436207309\n]'),
(256, 4, 'backend\\models\\VerifyIdForm::verifyIdentity', 1436207975.8405, '[::1][3][-]', '[Student #13] had his identity verified by Khalid'),
(257, 4, 'application', 1436207974.7881, '[::1][3][-]', '$_GET = [\n    ''r'' => ''student/view''\n    ''id'' => ''13''\n]\n\n$_POST = [\n    ''_csrf'' => ''clV4bnV6bS0RCjU4PE8faToEOR0QPSZCOzwPBTQqORUYDRAqNA8UYA==''\n    ''VerifyIdForm'' => [\n        ''idNumber'' => ''321''\n    ]\n]\n\n$_COOKIE = [\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''language'' => ''67060a96c74ce893ff45b186ae6a56e8c1ebc4ac8df24ad55d20805131eec25ea:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''132olqf3hlk2bf9tp8v16nl7g0''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_csrf'' => ''ae0f092835c4fc882a85307b652efada1f4a3d79e2936549a6914fa4d583d28fa:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"c_MVI5rDHQAseGKoIiwkAPT8jXhDAuyM\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''CONTENT_LENGTH'' => ''97''\n    ''HTTP_CACHE_CONTROL'' => ''max-age=0''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_ORIGIN'' => ''http://localhost''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''CONTENT_TYPE'' => ''application/x-www-form-urlencoded''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''app-employer=r14018bhhobgcup79i8toe9v11; app-backend=jv28k5vj2l9n6osivfdcr3qtu2; language=67060a96c74ce893ff45b186ae6a56e8c1ebc4ac8df24ad55d20805131eec25ea%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=132olqf3hlk2bf9tp8v16nl7g0; _ga=GA1.1.1762749747.1435241427; _csrf=ae0f092835c4fc882a85307b652efada1f4a3d79e2936549a6914fa4d583d28fa%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22c_MVI5rDHQAseGKoIiwkAPT8jXhDAuyM%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56546''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''POST''\n    ''QUERY_STRING'' => ''r=student%2Fview&id=13''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436207974.785\n    ''REQUEST_TIME'' => 1436207974\n]'),
(258, 4, 'backend\\models\\VerifyIdForm::verifyIdentity', 1436208129.2602, '[::1][3][-]', '[Student #13] had his identity verified by Khalid'),
(259, 4, 'application', 1436208129.2174, '[::1][3][-]', '$_GET = [\n    ''r'' => ''student/view''\n    ''id'' => ''13''\n]\n\n$_POST = [\n    ''_csrf'' => ''VHJwMFRCM083LT1mHXdBCxwjMUMxBXggHRsHWxUSZ3c.Khh0FTdKAg==''\n    ''VerifyIdForm'' => [\n        ''idNumber'' => ''321''\n    ]\n]\n\n$_COOKIE = [\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''language'' => ''67060a96c74ce893ff45b186ae6a56e8c1ebc4ac8df24ad55d20805131eec25ea:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''132olqf3hlk2bf9tp8v16nl7g0''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_csrf'' => ''ae0f092835c4fc882a85307b652efada1f4a3d79e2936549a6914fa4d583d28fa:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"c_MVI5rDHQAseGKoIiwkAPT8jXhDAuyM\\";}''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''CONTENT_LENGTH'' => ''97''\n    ''HTTP_CACHE_CONTROL'' => ''max-age=0''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_ORIGIN'' => ''http://localhost''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''CONTENT_TYPE'' => ''application/x-www-form-urlencoded''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''app-employer=r14018bhhobgcup79i8toe9v11; language=67060a96c74ce893ff45b186ae6a56e8c1ebc4ac8df24ad55d20805131eec25ea%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=132olqf3hlk2bf9tp8v16nl7g0; _ga=GA1.1.1762749747.1435241427; _csrf=ae0f092835c4fc882a85307b652efada1f4a3d79e2936549a6914fa4d583d28fa%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22c_MVI5rDHQAseGKoIiwkAPT8jXhDAuyM%22%3B%7D; app-backend=jv28k5vj2l9n6osivfdcr3qtu2''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56599''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''POST''\n    ''QUERY_STRING'' => ''r=student%2Fview&id=13''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436208129.215\n    ''REQUEST_TIME'' => 1436208129\n]'),
(260, 4, 'backend\\models\\VerifyIdForm::verifyIdentity', 1436208187.9347, '[::1][3][-]', '[Student #13] had his identity verified by Khalid'),
(261, 4, 'application', 1436208187.8942, '[::1][3][-]', '$_GET = [\n    ''r'' => ''student/view''\n    ''id'' => ''13''\n]\n\n$_POST = [\n    ''_csrf'' => ''RFQxUjNIQnItEkIZZCY3GgwHRB9DBTobPgViOkl.ARdwGXcaeC0kMw==''\n    ''VerifyIdForm'' => [\n        ''idNumber'' => ''123''\n    ]\n]\n\n$_COOKIE = [\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''language'' => ''67060a96c74ce893ff45b186ae6a56e8c1ebc4ac8df24ad55d20805131eec25ea:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-frontend'' => ''132olqf3hlk2bf9tp8v16nl7g0''\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''_gat'' => ''1''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_csrf'' => ''b6e140bcc0b1015d41efdf6457dc63babf4c5b410abf25c7d4865e0644fd1626a:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"iFsKWnuhHSuMpMxizQShz6Ce4MFHKefA\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''CONTENT_LENGTH'' => ''97''\n    ''HTTP_CACHE_CONTROL'' => ''max-age=0''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_ORIGIN'' => ''http://localhost''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''CONTENT_TYPE'' => ''application/x-www-form-urlencoded''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''app-employer=r14018bhhobgcup79i8toe9v11; language=67060a96c74ce893ff45b186ae6a56e8c1ebc4ac8df24ad55d20805131eec25ea%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-frontend=132olqf3hlk2bf9tp8v16nl7g0; app-backend=jv28k5vj2l9n6osivfdcr3qtu2; _gat=1; _ga=GA1.1.1762749747.1435241427; _csrf=b6e140bcc0b1015d41efdf6457dc63babf4c5b410abf25c7d4865e0644fd1626a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22iFsKWnuhHSuMpMxizQShz6Ce4MFHKefA%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56627''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''POST''\n    ''QUERY_STRING'' => ''r=student%2Fview&id=13''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436208187.892\n    ''REQUEST_TIME'' => 1436208187\n]'),
(262, 4, 'backend\\models\\VerifyIdForm::verifyIdentity', 1436209215.7612, '[::1][3][-]', '[Student #13] had his identity verified by Khalid'),
(263, 4, 'application', 1436209215.7222, '[::1][3][-]', '$_GET = [\n    ''r'' => ''student/view''\n    ''id'' => ''13''\n]\n\n$_POST = [\n    ''_csrf'' => ''MFNmRXdPUHhcZDUGQTs0ImQZLmgffxkrdzpLcRknMxl9AjUVDgYSVQ==''\n    ''VerifyIdForm'' => [\n        ''idNumber'' => ''321''\n    ]\n]\n\n$_COOKIE = [\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''language'' => ''b1a555c53ad9ee1d64515ae19576c71b099a8f68599514c999d8f2ff84692823a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"ar-KW\\";}''\n    ''app-frontend'' => ''6ogpgaoaj3smilsp521footq87''\n    ''_identity'' => ''3842c793553cd934eabd6c453be6f134383f81983bfa5833f6d0cfef514823a0a:2:{i:0;s:9:\\"_identity\\";i:1;s:47:\\"[13,\\"V0nH70XkhjxuBSP3k4Mi-Rq5c_Lj6bvc\\",2592000]\\";}''\n    ''app-employer'' => ''r14018bhhobgcup79i8toe9v11''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_gat'' => ''1''\n    ''_csrf'' => ''b29532f58681f0f9584642670057b8574ff88eb535f2e5e31a136193902830f4a:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"l7SC6tdZTJH-h0ISGi-4nhcaMQSPyIB-\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''CONTENT_LENGTH'' => ''97''\n    ''HTTP_CACHE_CONTROL'' => ''max-age=0''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_ORIGIN'' => ''http://localhost''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''CONTENT_TYPE'' => ''application/x-www-form-urlencoded''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''app-backend=jv28k5vj2l9n6osivfdcr3qtu2; language=b1a555c53ad9ee1d64515ae19576c71b099a8f68599514c999d8f2ff84692823a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22ar-KW%22%3B%7D; app-frontend=6ogpgaoaj3smilsp521footq87; _identity=3842c793553cd934eabd6c453be6f134383f81983bfa5833f6d0cfef514823a0a%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A47%3A%22%5B13%2C%22V0nH70XkhjxuBSP3k4Mi-Rq5c_Lj6bvc%22%2C2592000%5D%22%3B%7D; app-employer=r14018bhhobgcup79i8toe9v11; _ga=GA1.1.1762749747.1435241427; _gat=1; _csrf=b29532f58681f0f9584642670057b8574ff88eb535f2e5e31a136193902830f4a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22l7SC6tdZTJH-h0ISGi-4nhcaMQSPyIB-%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''56787''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''POST''\n    ''QUERY_STRING'' => ''r=student%2Fview&id=13''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=student%2Fview&id=13''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436209215.72\n    ''REQUEST_TIME'' => 1436209215\n]'),
(264, 4, 'backend\\models\\Job::verify', 1436265545.3367, '[::1][3][-]', '[Job #18] has been added to broadcasting queue'),
(265, 4, 'backend\\models\\Job::verify', 1436265545.3373, '[::1][3][-]', '[Job #18] has been approved by Khalid'),
(266, 4, 'application', 1436265545.3017, '[::1][3][-]', '$_GET = [\n    ''r'' => ''job/verify''\n    ''id'' => ''18''\n]\n\n$_COOKIE = [\n    ''app-backend'' => ''jv28k5vj2l9n6osivfdcr3qtu2''\n    ''language'' => ''b1d8e42b037442fcbe2749affd7636a7b7996867ae8d07887e0c765a6b69e250a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-employer'' => ''prufr3lk88rf3s7aj6nvtbb935''\n    ''_identity'' => ''bdde57f2604a977245e17653aa52ac049d015c8aed0e9f1f3d25933a87975a2ea:2:{i:0;s:9:\\"_identity\\";i:1;s:46:\\"[1,\\"AWLsiuInKDt_5Jz8ARA6c0q2dHX6-joB\\",2592000]\\";}''\n    ''app-frontend'' => ''6ogpgaoaj3smilsp521footq87''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''_csrf'' => ''d8b7871e20a223caf81c34c607d2208ee610cce7fb822d71f1b66b29960e77d3a:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"BsDIMSI6DNfNqPpiG-YQN_D_zHLOsLYv\\";}''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n    ''__returnUrl'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''__id'' => 3\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''HTTP_ACCEPT'' => ''text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/backend/web/index.php?r=job%2Fview&id=18''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate, sdch''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''app-backend=jv28k5vj2l9n6osivfdcr3qtu2; language=b1d8e42b037442fcbe2749affd7636a7b7996867ae8d07887e0c765a6b69e250a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-employer=prufr3lk88rf3s7aj6nvtbb935; _identity=bdde57f2604a977245e17653aa52ac049d015c8aed0e9f1f3d25933a87975a2ea%3A2%3A%7Bi%3A0%3Bs%3A9%3A%22_identity%22%3Bi%3A1%3Bs%3A46%3A%22%5B1%2C%22AWLsiuInKDt_5Jz8ARA6c0q2dHX6-joB%22%2C2592000%5D%22%3B%7D; app-frontend=6ogpgaoaj3smilsp521footq87; _ga=GA1.1.1762749747.1435241427; _csrf=d8b7871e20a223caf81c34c607d2208ee610cce7fb822d71f1b66b29960e77d3a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22BsDIMSI6DNfNqPpiG-YQN_D_zHLOsLYv%22%3B%7D''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/backend/web/index.php''\n    ''REMOTE_PORT'' => ''58088''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''GET''\n    ''QUERY_STRING'' => ''r=job%2Fverify&id=18''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/backend/web/index.php?r=job%2Fverify&id=18''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/backend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436265545.299\n    ''REQUEST_TIME'' => 1436265545\n]'),
(267, 4, 'common\\models\\Student::broadcastDailyNotificationEmail', 1436390728.5955, '[-][-][-]', '[Daily Notifications] Notifications emailed to 7 students'),
(268, 4, 'common\\models\\Employer::broadcastDailyNotificationEmail', 1436390728.6191, '[-][-][-]', '[Daily Notifications] Notifications emailed to 1 employers'),
(269, 4, 'application', 1436390728.5145, '[-][-][-]', '$_SERVER = [\n    ''TERM_PROGRAM'' => ''Apple_Terminal''\n    ''SHELL'' => ''/bin/bash''\n    ''TERM'' => ''xterm-256color''\n    ''TMPDIR'' => ''/var/folders/t0/ssb8ck0j4c106w8w9hzftjcc0000gn/T/''\n    ''Apple_PubSub_Socket_Render'' => ''/private/tmp/com.apple.launchd.BxaW48gB1r/Render''\n    ''TERM_PROGRAM_VERSION'' => ''343.7''\n    ''TERM_SESSION_ID'' => ''E77B0D3E-C3E2-4E6D-8577-152CB8A2F775''\n    ''USER'' => ''BAWES''\n    ''SSH_AUTH_SOCK'' => ''/private/tmp/com.apple.launchd.GpB88CPHi5/Listeners''\n    ''__CF_USER_TEXT_ENCODING'' => ''0x1F5:0x0:0x0''\n    ''PATH'' => ''/usr/local/mysql/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/BAWES/Library/Android/sdk/platform-tools:/Users/BAWES/Library/Android/sdk/tools:/Library/Java/JavaVirtualMachines/jdk1.8.0_31.jdk/Contents/Home/bin:/Users/BAWES/Library/apache-ant-1.9.4/bin''\n    ''PWD'' => ''/Users/BAWES/Sites/studenthub''\n    ''XPC_FLAGS'' => ''0x0''\n    ''XPC_SERVICE_NAME'' => ''0''\n    ''SHLVL'' => ''1''\n    ''HOME'' => ''/Users/BAWES''\n    ''LOGNAME'' => ''BAWES''\n    ''LC_CTYPE'' => ''UTF-8''\n    ''_'' => ''./yii''\n    ''OLDPWD'' => ''/Users/BAWES/Sites''\n    ''PHP_SELF'' => ''./yii''\n    ''SCRIPT_NAME'' => ''./yii''\n    ''SCRIPT_FILENAME'' => ''./yii''\n    ''PATH_TRANSLATED'' => ''./yii''\n    ''DOCUMENT_ROOT'' => ''''\n    ''REQUEST_TIME_FLOAT'' => 1436390728.513\n    ''REQUEST_TIME'' => 1436390728\n    ''argv'' => [\n        0 => ''./yii''\n        1 => ''cron/daily-email''\n    ]\n    ''argc'' => 2\n]'),
(270, 4, 'common\\models\\Student::broadcastDailyNotificationEmail', 1436395085.2017, '[-][-][-]', '[Daily Notifications] Notifications emailed to 7 students'),
(271, 4, 'common\\models\\Employer::broadcastDailyNotificationEmail', 1436395085.2085, '[-][-][-]', '[Daily Notifications] Notifications emailed to 1 employers'),
(272, 4, 'application', 1436395049.2716, '[-][-][-]', '$_SERVER = [\n    ''TERM_PROGRAM'' => ''Apple_Terminal''\n    ''SHELL'' => ''/bin/bash''\n    ''TERM'' => ''xterm-256color''\n    ''TMPDIR'' => ''/var/folders/t0/ssb8ck0j4c106w8w9hzftjcc0000gn/T/''\n    ''Apple_PubSub_Socket_Render'' => ''/private/tmp/com.apple.launchd.BxaW48gB1r/Render''\n    ''TERM_PROGRAM_VERSION'' => ''343.7''\n    ''TERM_SESSION_ID'' => ''E77B0D3E-C3E2-4E6D-8577-152CB8A2F775''\n    ''USER'' => ''BAWES''\n    ''SSH_AUTH_SOCK'' => ''/private/tmp/com.apple.launchd.GpB88CPHi5/Listeners''\n    ''__CF_USER_TEXT_ENCODING'' => ''0x1F5:0x0:0x0''\n    ''PATH'' => ''/usr/local/mysql/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/BAWES/Library/Android/sdk/platform-tools:/Users/BAWES/Library/Android/sdk/tools:/Library/Java/JavaVirtualMachines/jdk1.8.0_31.jdk/Contents/Home/bin:/Users/BAWES/Library/apache-ant-1.9.4/bin''\n    ''PWD'' => ''/Users/BAWES/Sites/studenthub''\n    ''XPC_FLAGS'' => ''0x0''\n    ''XPC_SERVICE_NAME'' => ''0''\n    ''SHLVL'' => ''1''\n    ''HOME'' => ''/Users/BAWES''\n    ''LOGNAME'' => ''BAWES''\n    ''LC_CTYPE'' => ''UTF-8''\n    ''_'' => ''./yii''\n    ''OLDPWD'' => ''/Users/BAWES/Sites/studenthub/console/runtime''\n    ''PHP_SELF'' => ''./yii''\n    ''SCRIPT_NAME'' => ''./yii''\n    ''SCRIPT_FILENAME'' => ''./yii''\n    ''PATH_TRANSLATED'' => ''./yii''\n    ''DOCUMENT_ROOT'' => ''''\n    ''REQUEST_TIME_FLOAT'' => 1436395049.2698\n    ''REQUEST_TIME'' => 1436395049\n    ''argv'' => [\n        0 => ''./yii''\n        1 => ''cron/daily-email''\n    ]\n    ''argc'' => 2\n]'),
(273, 4, 'common\\models\\Student::broadcastDailyNotificationEmail', 1436553812.5542, '[-][-][-]', '[Daily Notifications] Notifications emailed to 7 students'),
(274, 4, 'application', 1436553763.5416, '[-][-][-]', '$_SERVER = [\n    ''TERM_PROGRAM'' => ''Apple_Terminal''\n    ''SHELL'' => ''/bin/bash''\n    ''TERM'' => ''xterm-256color''\n    ''TMPDIR'' => ''/var/folders/t0/ssb8ck0j4c106w8w9hzftjcc0000gn/T/''\n    ''Apple_PubSub_Socket_Render'' => ''/private/tmp/com.apple.launchd.Ha0qwaedpr/Render''\n    ''TERM_PROGRAM_VERSION'' => ''343.7''\n    ''TERM_SESSION_ID'' => ''76693B65-AAE6-4756-A514-F3E9546CD8FF''\n    ''USER'' => ''BAWES''\n    ''SSH_AUTH_SOCK'' => ''/private/tmp/com.apple.launchd.9VV2cQ5fw8/Listeners''\n    ''__CF_USER_TEXT_ENCODING'' => ''0x1F5:0x0:0x0''\n    ''PATH'' => ''/usr/local/mysql/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/BAWES/Library/Android/sdk/platform-tools:/Users/BAWES/Library/Android/sdk/tools:/Library/Java/JavaVirtualMachines/jdk1.8.0_31.jdk/Contents/Home/bin:/Users/BAWES/Library/apache-ant-1.9.4/bin''\n    ''PWD'' => ''/Users/BAWES/Sites/studenthub''\n    ''XPC_FLAGS'' => ''0x0''\n    ''XPC_SERVICE_NAME'' => ''0''\n    ''SHLVL'' => ''1''\n    ''HOME'' => ''/Users/BAWES''\n    ''LOGNAME'' => ''BAWES''\n    ''LC_CTYPE'' => ''UTF-8''\n    ''OLDPWD'' => ''/Users/BAWES''\n    ''_'' => ''./yii''\n    ''PHP_SELF'' => ''./yii''\n    ''SCRIPT_NAME'' => ''./yii''\n    ''SCRIPT_FILENAME'' => ''./yii''\n    ''PATH_TRANSLATED'' => ''./yii''\n    ''DOCUMENT_ROOT'' => ''''\n    ''REQUEST_TIME_FLOAT'' => 1436553763.54\n    ''REQUEST_TIME'' => 1436553763\n    ''argv'' => [\n        0 => ''./yii''\n        1 => ''cron/daily-email''\n    ]\n    ''argc'' => 2\n]'),
(275, 4, 'common\\models\\Student::broadcastNotificationEmail', 1436554303.6496, '[-][-][-]', '[Notifications] Notifications emailed to 6 students'),
(276, 4, 'application', 1436554264.244, '[-][-][-]', '$_SERVER = [\n    ''TERM_PROGRAM'' => ''Apple_Terminal''\n    ''SHELL'' => ''/bin/bash''\n    ''TERM'' => ''xterm-256color''\n    ''TMPDIR'' => ''/var/folders/t0/ssb8ck0j4c106w8w9hzftjcc0000gn/T/''\n    ''Apple_PubSub_Socket_Render'' => ''/private/tmp/com.apple.launchd.Ha0qwaedpr/Render''\n    ''TERM_PROGRAM_VERSION'' => ''343.7''\n    ''TERM_SESSION_ID'' => ''76693B65-AAE6-4756-A514-F3E9546CD8FF''\n    ''USER'' => ''BAWES''\n    ''SSH_AUTH_SOCK'' => ''/private/tmp/com.apple.launchd.9VV2cQ5fw8/Listeners''\n    ''__CF_USER_TEXT_ENCODING'' => ''0x1F5:0x0:0x0''\n    ''PATH'' => ''/usr/local/mysql/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/BAWES/Library/Android/sdk/platform-tools:/Users/BAWES/Library/Android/sdk/tools:/Library/Java/JavaVirtualMachines/jdk1.8.0_31.jdk/Contents/Home/bin:/Users/BAWES/Library/apache-ant-1.9.4/bin''\n    ''PWD'' => ''/Users/BAWES/Sites/studenthub''\n    ''XPC_FLAGS'' => ''0x0''\n    ''XPC_SERVICE_NAME'' => ''0''\n    ''SHLVL'' => ''1''\n    ''HOME'' => ''/Users/BAWES''\n    ''LOGNAME'' => ''BAWES''\n    ''LC_CTYPE'' => ''UTF-8''\n    ''OLDPWD'' => ''/Users/BAWES''\n    ''_'' => ''./yii''\n    ''PHP_SELF'' => ''./yii''\n    ''SCRIPT_NAME'' => ''./yii''\n    ''SCRIPT_FILENAME'' => ''./yii''\n    ''PATH_TRANSLATED'' => ''./yii''\n    ''DOCUMENT_ROOT'' => ''''\n    ''REQUEST_TIME_FLOAT'' => 1436554264.2421\n    ''REQUEST_TIME'' => 1436554264\n    ''argv'' => [\n        0 => ''./yii''\n        1 => ''cron/daily-email''\n    ]\n    ''argc'' => 2\n]'),
(277, 4, 'common\\models\\Student::broadcastNotificationEmail', 1436554385.3318, '[-][-][-]', '[Notifications] Notifications emailed to 2 students'),
(278, 4, 'application', 1436554371.6703, '[-][-][-]', '$_SERVER = [\n    ''TERM_PROGRAM'' => ''Apple_Terminal''\n    ''SHELL'' => ''/bin/bash''\n    ''TERM'' => ''xterm-256color''\n    ''TMPDIR'' => ''/var/folders/t0/ssb8ck0j4c106w8w9hzftjcc0000gn/T/''\n    ''Apple_PubSub_Socket_Render'' => ''/private/tmp/com.apple.launchd.Ha0qwaedpr/Render''\n    ''TERM_PROGRAM_VERSION'' => ''343.7''\n    ''TERM_SESSION_ID'' => ''76693B65-AAE6-4756-A514-F3E9546CD8FF''\n    ''USER'' => ''BAWES''\n    ''SSH_AUTH_SOCK'' => ''/private/tmp/com.apple.launchd.9VV2cQ5fw8/Listeners''\n    ''__CF_USER_TEXT_ENCODING'' => ''0x1F5:0x0:0x0''\n    ''PATH'' => ''/usr/local/mysql/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/BAWES/Library/Android/sdk/platform-tools:/Users/BAWES/Library/Android/sdk/tools:/Library/Java/JavaVirtualMachines/jdk1.8.0_31.jdk/Contents/Home/bin:/Users/BAWES/Library/apache-ant-1.9.4/bin''\n    ''PWD'' => ''/Users/BAWES/Sites/studenthub''\n    ''XPC_FLAGS'' => ''0x0''\n    ''XPC_SERVICE_NAME'' => ''0''\n    ''SHLVL'' => ''1''\n    ''HOME'' => ''/Users/BAWES''\n    ''LOGNAME'' => ''BAWES''\n    ''LC_CTYPE'' => ''UTF-8''\n    ''OLDPWD'' => ''/Users/BAWES''\n    ''_'' => ''./yii''\n    ''PHP_SELF'' => ''./yii''\n    ''SCRIPT_NAME'' => ''./yii''\n    ''SCRIPT_FILENAME'' => ''./yii''\n    ''PATH_TRANSLATED'' => ''./yii''\n    ''DOCUMENT_ROOT'' => ''''\n    ''REQUEST_TIME_FLOAT'' => 1436554371.6688\n    ''REQUEST_TIME'' => 1436554371\n    ''argv'' => [\n        0 => ''./yii''\n        1 => ''cron/weekly-email''\n    ]\n    ''argc'' => 2\n]'),
(279, 4, 'common\\models\\Employer::broadcastNotificationEmail', 1436554686.673, '[-][-][-]', '[Notifications] Notifications emailed to 1 employers'),
(280, 4, 'application', 1436554680.3032, '[-][-][-]', '$_SERVER = [\n    ''TERM_PROGRAM'' => ''Apple_Terminal''\n    ''SHELL'' => ''/bin/bash''\n    ''TERM'' => ''xterm-256color''\n    ''TMPDIR'' => ''/var/folders/t0/ssb8ck0j4c106w8w9hzftjcc0000gn/T/''\n    ''Apple_PubSub_Socket_Render'' => ''/private/tmp/com.apple.launchd.Ha0qwaedpr/Render''\n    ''TERM_PROGRAM_VERSION'' => ''343.7''\n    ''TERM_SESSION_ID'' => ''76693B65-AAE6-4756-A514-F3E9546CD8FF''\n    ''USER'' => ''BAWES''\n    ''SSH_AUTH_SOCK'' => ''/private/tmp/com.apple.launchd.9VV2cQ5fw8/Listeners''\n    ''__CF_USER_TEXT_ENCODING'' => ''0x1F5:0x0:0x0''\n    ''PATH'' => ''/usr/local/mysql/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/BAWES/Library/Android/sdk/platform-tools:/Users/BAWES/Library/Android/sdk/tools:/Library/Java/JavaVirtualMachines/jdk1.8.0_31.jdk/Contents/Home/bin:/Users/BAWES/Library/apache-ant-1.9.4/bin''\n    ''PWD'' => ''/Users/BAWES/Sites/studenthub''\n    ''XPC_FLAGS'' => ''0x0''\n    ''XPC_SERVICE_NAME'' => ''0''\n    ''SHLVL'' => ''1''\n    ''HOME'' => ''/Users/BAWES''\n    ''LOGNAME'' => ''BAWES''\n    ''LC_CTYPE'' => ''UTF-8''\n    ''OLDPWD'' => ''/Users/BAWES''\n    ''_'' => ''./yii''\n    ''PHP_SELF'' => ''./yii''\n    ''SCRIPT_NAME'' => ''./yii''\n    ''SCRIPT_FILENAME'' => ''./yii''\n    ''PATH_TRANSLATED'' => ''./yii''\n    ''DOCUMENT_ROOT'' => ''''\n    ''REQUEST_TIME_FLOAT'' => 1436554680.3017\n    ''REQUEST_TIME'' => 1436554680\n    ''argv'' => [\n        0 => ''./yii''\n        1 => ''cron/daily-email''\n    ]\n    ''argc'' => 2\n]'),
(281, 4, 'common\\models\\Employer::broadcastNotificationEmail', 1436554737.0065, '[-][-][-]', '[Notifications] Notifications emailed to 1 employers'),
(282, 4, 'application', 1436554729.8766, '[-][-][-]', '$_SERVER = [\n    ''TERM_PROGRAM'' => ''Apple_Terminal''\n    ''SHELL'' => ''/bin/bash''\n    ''TERM'' => ''xterm-256color''\n    ''TMPDIR'' => ''/var/folders/t0/ssb8ck0j4c106w8w9hzftjcc0000gn/T/''\n    ''Apple_PubSub_Socket_Render'' => ''/private/tmp/com.apple.launchd.Ha0qwaedpr/Render''\n    ''TERM_PROGRAM_VERSION'' => ''343.7''\n    ''TERM_SESSION_ID'' => ''76693B65-AAE6-4756-A514-F3E9546CD8FF''\n    ''USER'' => ''BAWES''\n    ''SSH_AUTH_SOCK'' => ''/private/tmp/com.apple.launchd.9VV2cQ5fw8/Listeners''\n    ''__CF_USER_TEXT_ENCODING'' => ''0x1F5:0x0:0x0''\n    ''PATH'' => ''/usr/local/mysql/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/BAWES/Library/Android/sdk/platform-tools:/Users/BAWES/Library/Android/sdk/tools:/Library/Java/JavaVirtualMachines/jdk1.8.0_31.jdk/Contents/Home/bin:/Users/BAWES/Library/apache-ant-1.9.4/bin''\n    ''PWD'' => ''/Users/BAWES/Sites/studenthub''\n    ''XPC_FLAGS'' => ''0x0''\n    ''XPC_SERVICE_NAME'' => ''0''\n    ''SHLVL'' => ''1''\n    ''HOME'' => ''/Users/BAWES''\n    ''LOGNAME'' => ''BAWES''\n    ''LC_CTYPE'' => ''UTF-8''\n    ''OLDPWD'' => ''/Users/BAWES''\n    ''_'' => ''./yii''\n    ''PHP_SELF'' => ''./yii''\n    ''SCRIPT_NAME'' => ''./yii''\n    ''SCRIPT_FILENAME'' => ''./yii''\n    ''PATH_TRANSLATED'' => ''./yii''\n    ''DOCUMENT_ROOT'' => ''''\n    ''REQUEST_TIME_FLOAT'' => 1436554729.8752\n    ''REQUEST_TIME'' => 1436554729\n    ''argv'' => [\n        0 => ''./yii''\n        1 => ''cron/weekly-email''\n    ]\n    ''argc'' => 2\n]'),
(283, 4, 'common\\models\\Student::beforeSave', 1436897244.3043, '[::1][-][-]', 'New student signup - Km Km'),
(284, 4, 'application', 1436897243.5868, '[::1][-][-]', '$_GET = [\n    ''r'' => ''register/validate''\n]\n\n$_POST = [\n    ''student_email_preference'' => ''1''\n    ''student_firstname'' => ''Km''\n    ''student_lastname'' => ''Km''\n    ''student_dob'' => ''1988/07/15''\n    ''country_id'' => ''84''\n    ''degree_id'' => ''3''\n    ''student_enrolment_year'' => ''2012''\n    ''student_graduating_year'' => ''2017''\n    ''majorsSelected'' => [\n        0 => ''336''\n    ]\n    ''student_gpa'' => ''3''\n    ''student_gender'' => ''1''\n    ''languagesSelected'' => [\n        0 => ''1''\n        1 => ''2''\n        2 => ''4''\n    ]\n    ''student_english_level'' => ''2''\n    ''student_transportation'' => ''1''\n    ''student_club'' => ''''\n    ''student_sport'' => ''''\n    ''student_experience_company'' => ''''\n    ''student_experience_position'' => ''''\n    ''student_skill'' => ''''\n    ''student_hobby'' => ''''\n    ''student_interestingfacts'' => ''''\n    ''student_photo'' => ''''\n    ''student_cv'' => ''''\n    ''terms'' => ''1''\n    ''step'' => ''2''\n    ''university_id'' => ''1''\n    ''student_email'' => ''dwadaww@gust.edu.kw''\n    ''student_password_hash'' => ''dwadaw''\n    ''student_contact_number'' => ''99811042''\n]\n\n$_COOKIE = [\n    ''language'' => ''68767b7580c7d6ecdc48df68df76be0dcdf1cf5f62fbc387be032deccf94b164a:2:{i:0;s:8:\\"language\\";i:1;s:5:\\"en-US\\";}''\n    ''app-employer'' => ''7hvjkdfluik94k58c3q76htlt6''\n    ''_csrf'' => ''2266411ac3ee8557007eba9d9ddf1b75684b817f3fac1ce97437d6db0f0632aca:2:{i:0;s:5:\\"_csrf\\";i:1;s:32:\\"2WV5RRcS-gzW2xtKpGi4x1EMYMQChV2s\\";}''\n    ''_gat'' => ''1''\n    ''_ga'' => ''GA1.1.1762749747.1435241427''\n    ''app-frontend'' => ''0r0nohf5ripjog0hn5oj2fh7u2''\n]\n\n$_SESSION = [\n    ''__flash'' => []\n]\n\n$_SERVER = [\n    ''HTTP_HOST'' => ''localhost''\n    ''HTTP_CONNECTION'' => ''keep-alive''\n    ''CONTENT_LENGTH'' => ''657''\n    ''HTTP_ACCEPT'' => ''*/*''\n    ''HTTP_ORIGIN'' => ''http://localhost''\n    ''HTTP_X_CSRF_TOKEN'' => ''emxaUVhrZmtIOwxkCjkFOFcLIAZqExIgCiszZSBaIyYjIQsSMD1UGA==''\n    ''HTTP_X_REQUESTED_WITH'' => ''XMLHttpRequest''\n    ''HTTP_USER_AGENT'' => ''Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.132 Safari/537.36''\n    ''CONTENT_TYPE'' => ''application/x-www-form-urlencoded; charset=UTF-8''\n    ''HTTP_REFERER'' => ''http://localhost/~BAWES/studenthub/frontend/web/index.php?r=register%2Fregister&university=1''\n    ''HTTP_ACCEPT_ENCODING'' => ''gzip, deflate''\n    ''HTTP_ACCEPT_LANGUAGE'' => ''en-US,en;q=0.8,ar;q=0.6''\n    ''HTTP_COOKIE'' => ''language=68767b7580c7d6ecdc48df68df76be0dcdf1cf5f62fbc387be032deccf94b164a%3A2%3A%7Bi%3A0%3Bs%3A8%3A%22language%22%3Bi%3A1%3Bs%3A5%3A%22en-US%22%3B%7D; app-employer=7hvjkdfluik94k58c3q76htlt6; _csrf=2266411ac3ee8557007eba9d9ddf1b75684b817f3fac1ce97437d6db0f0632aca%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%222WV5RRcS-gzW2xtKpGi4x1EMYMQChV2s%22%3B%7D; _gat=1; _ga=GA1.1.1762749747.1435241427; app-frontend=0r0nohf5ripjog0hn5oj2fh7u2''\n    ''PATH'' => ''/usr/bin:/bin:/usr/sbin:/sbin''\n    ''SERVER_SIGNATURE'' => ''''\n    ''SERVER_SOFTWARE'' => ''Apache/2.4.10 (Unix) PHP/5.6.7''\n    ''SERVER_NAME'' => ''localhost''\n    ''SERVER_ADDR'' => ''::1''\n    ''SERVER_PORT'' => ''80''\n    ''REMOTE_ADDR'' => ''::1''\n    ''DOCUMENT_ROOT'' => ''/Library/WebServer/Documents''\n    ''REQUEST_SCHEME'' => ''http''\n    ''CONTEXT_PREFIX'' => ''/~BAWES''\n    ''CONTEXT_DOCUMENT_ROOT'' => ''/Users/BAWES/Sites''\n    ''SERVER_ADMIN'' => ''you@example.com''\n    ''SCRIPT_FILENAME'' => ''/Users/BAWES/Sites/studenthub/frontend/web/index.php''\n    ''REMOTE_PORT'' => ''60276''\n    ''GATEWAY_INTERFACE'' => ''CGI/1.1''\n    ''SERVER_PROTOCOL'' => ''HTTP/1.1''\n    ''REQUEST_METHOD'' => ''POST''\n    ''QUERY_STRING'' => ''r=register%2Fvalidate''\n    ''REQUEST_URI'' => ''/~BAWES/studenthub/frontend/web/index.php?r=register%2Fvalidate''\n    ''SCRIPT_NAME'' => ''/~BAWES/studenthub/frontend/web/index.php''\n    ''PHP_SELF'' => ''/~BAWES/studenthub/frontend/web/index.php''\n    ''REQUEST_TIME_FLOAT'' => 1436897243.584\n    ''REQUEST_TIME'' => 1436897243\n]');
...
(24, 1, 13, 15, 1, 1, '2015-06-05 13:22:51'),
(25, 2, 13, 14, 1, 0, '2015-06-05 13:23:08'),
(26, 1, 13, 15, 1, 1, '2015-06-14 10:25:47'),
(27, 2, 13, 14, 1, 0, '2015-06-14 10:25:54'),
(28, 2, 13, 14, 1, 0, '2015-06-14 18:13:26'),
(29, 1, 13, 15, 1, 1, '2015-06-14 18:13:37'),
(30, 1, 13, 15, 1, 1, '2015-06-15 08:45:18'),
(31, 1, 13, 15, 1, 1, '2015-06-15 08:45:31'),
(32, 1, 13, 15, 1, 1, '2015-06-15 08:45:48'),
(33, 1, 13, 15, 1, 1, '2015-06-15 08:46:14'),
(34, 1, 13, 15, 1, 1, '2015-06-15 08:46:30'),
(35, 2, 13, 14, 1, 0, '2015-06-15 08:47:06'),
(36, 1, 13, 15, 1, 1, '2015-06-15 08:51:56'),
(37, 1, 13, 15, 1, 1, '2015-06-15 08:53:05'),
(38, 2, 13, 14, 1, 0, '2015-06-15 08:53:11'),
(39, 2, 13, 14, 1, 0, '2015-06-15 08:53:31'),
(40, 1, 13, 15, 1, 1, '2015-06-15 08:53:36'),
(41, 1, 13, 15, 1, 1, '2015-06-29 10:54:28'),
(42, 1, 13, 15, 1, 0, '2015-07-05 20:27:47'),
(43, 1, 13, 15, 1, 0, '2015-07-05 20:31:20'),
(44, 1, 13, 15, 1, 0, '2015-07-05 20:32:06'),
(45, 1, 13, 15, 1, 0, '2015-07-05 20:35:07'),
(46, 1, 13, 15, 1, 0, '2015-07-05 20:53:13'),
(47, 1, 13, 15, 1, 0, '2015-07-05 20:54:00'),
(48, 2, 13, 14, 1, 0, '2015-07-05 20:55:57'),
(49, 1, 13, 15, 1, 0, '2015-07-05 20:57:00'),
(50, 1, 13, 15, 1, 0, '2015-07-05 20:57:52'),
(51, 1, 13, 15, 1, 0, '2015-07-05 21:00:31'),
(52, 1, 13, 15, 1, 0, '2015-07-05 21:02:46'),
(53, 2, 13, 14, 1, 0, '2015-07-07 13:32:51'),
(54, 2, 13, 14, 1, 0, '2015-07-08 14:58:28'),
(55, 1, 13, 15, 1, 0, '2015-07-08 14:58:34');
...
(10, 13, 14, 1, 1, '2015-05-26 15:32:51'),
(12, 17, 14, 1, 0, '2015-05-26 15:32:51'),
(13, 18, 14, 0, 0, '2015-05-26 15:32:51'),
(14, 20, 14, 1, 0, '2015-05-26 15:32:51'),
(15, 13, 15, 1, 1, '2015-05-26 15:32:59'),
(17, 15, 15, 1, 0, '2015-05-26 15:32:59'),
(18, 16, 15, 1, 0, '2015-05-26 15:32:59'),
(19, 17, 15, 1, 0, '2015-05-26 15:32:59'),
(20, 18, 15, 0, 0, '2015-05-26 15:32:59'),
(21, 19, 15, 1, 0, '2015-05-26 15:32:59'),
(22, 20, 15, 1, 0, '2015-05-26 15:32:59'),
(27, 14, 14, 1, 0, '2015-05-28 16:43:05'),
(28, 14, 15, 1, 0, '2015-05-28 16:43:05'),
(29, 22, 15, 1, 0, '2015-05-29 10:11:37');
...
('io2a9r3c94r8bogurjsjapeql6', 1436900787, 0x5f5f666c6173687c613a303a7b7d5f5f69647c693a31333b);
...
INSERT INTO `student` (`student_id`, `degree_id`, `country_id`, `university_id`, `student_firstname`, `student_lastname`, `student_dob`, `student_enrolment_year`, `student_graduating_year`, `student_gpa`, `student_english_level`, `student_gender`, `student_transportation`, `student_contact_number`, `student_interestingfacts`, `student_photo`, `student_cv`, `student_skill`, `student_hobby`, `student_club`, `student_sport`, `student_experience_company`, `student_experience_position`, `student_verification_attachment`, `student_email_verification`, `student_id_verification`, `student_id_number`, `student_email_preference`, `student_email`, `student_auth_key`, `student_password_hash`, `student_password_reset_token`, `student_language_pref`, `student_banned`, `student_support_field`, `student_limit_email`, `student_updated_datetime`, `student_datetime`) VALUES
(13, 1, 84, 1, 'Khalid', 'Al Mutawa', '1984-08-15', 2007, 2014, '3.20', 2, 1, 1, '99811042', 'I like eating chicken wings\r\nThis is a cool fact\r\ntrust me it is', 'eGY4NtOvk9DVYOvqEzcMZ5XcuhFxS7kN.png', NULL, 'teamwork', 'cooking,cleaning,updating website', 'Anime Club,Photography Club', 'Tennis,Football', NULL, NULL, NULL, 1, 1, '321', 1, 'khalid@gust.edu.kw', 'V0nH70XkhjxuBSP3k4Mi-Rq5c_Lj6bvc', '$2y$13$EIHdE9kcr1zAA4HIi29iS.JlPF.0hrJQdoAbbV53aoVtZCETzo84C', NULL, 'en-US', 0, '', '2015-05-10 10:03:03', '2015-07-14 21:07:46', '2015-04-27 10:51:37'),
(14, 2, 3, 1, 'Khalid', 'Mutawa', '1990-05-08', 2013, 2014, '3.00', 2, 1, 1, '99811042', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 1, 'gust0003887@gust.edu.kw', '441qQzDCYen0l4WffdcHa-3HwSSf6l9s', '$2y$13$lXNk5kJBFQGp5ucQDP8D5el9ASYVZusUHXDfZnYxJ9if5XPBuRuwG', '', 'en-US', 0, '', '0000-00-00 00:00:00', '2015-05-02 17:15:37', '2015-05-02 17:15:37'),
(15, 4, 3, 2, 'Mohammed', 'Ashkanani', '1989-05-30', 2013, 2015, '3.00', 2, 1, 1, '99811042', NULL, 'lTJL5P-XkYyxOz-YyHCj3e-a3wzDsWN8.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 't72RPXKpgRUrK5cjkNLNCTUeE0_sIFBm.png', 1, 1, NULL, 1, 'test@test.com', '2JdqmrQUWWHgk3HypwDYvgeVxDKvJaBU', '$2y$13$XP2e3uNZc53RWHM9rz7HuufcL6ZWL2wTa5LNi8Ia29NG5lb7nFHOe', '', 'en-US', 0, '', '2015-05-08 12:57:33', '2015-05-08 22:57:38', '2015-05-08 12:57:33'),
(16, 4, 4, 2, 'Saoud', 'Turki', '1992-09-09', 2013, 2017, '3.00', 2, 1, 0, '99811042', NULL, 'Rz-RICTfOL9Tps8BcYlFNrg8VWIsOleh.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'pG5MolYl7fX6z2eSSdJBArWnzDk1Nhi_.png', 1, 1, NULL, 1, 'km@km.com', 'qm6tV2DTlQE8oX5xelqo_EY2oAarFIjK', '$2y$13$ecT3h6RypLdNZjJgpjXoX.YMKC5s1mNr.oxTkckDeSu3sX66m5PCq', 'zcTJRTTcxe3YZEn7GuzVL3ilCU1-5Rwo_1431114197', 'en-US', 0, '', '2015-05-08 22:43:17', '2015-05-26 14:52:49', '2015-05-08 13:10:56'),
(17, 2, 182, 2, 'Saoud', 'AlTurki', '1979-05-30', 2013, 2017, '3.00', 1, 1, 0, '99811042', NULL, 'KYj-ohYWhlcJymuugyeggv5xN4MTgx4F.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'YOldR1yk-dJ_JEl4lotG5c0l_wMzWagm.png', 1, 1, NULL, 1, 'khalid@bto.com', 'wx9F3seITdpLCwcGHh_eJJHRWxDB8TEH', '$2y$13$AYId0O0xDrErojHzj6N5EONFl8UGxvhK9LH9tzsv0NLDfZTvc28/e', '', 'en-US', 0, '', '2015-05-08 13:21:33', '2015-05-08 13:21:33', '2015-05-08 13:21:33'),
(18, 2, 4, 1, 'dwadwa', 'dwadwad', '1991-05-10', 2013, 2016, '3.00', 0, 0, 0, '99811042', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 1, 'dwa@gust.edu.kw', 'DlGj_cCqGzGO4y7lKnfewauSb1-At9T8', '$2y$13$FuUyPrnTdorb68V0Hy1bgud9LXRPWgy9QEJo8v.1VWhX8/WLGw/d2', '', 'en-US', 0, '', '2015-05-08 13:27:57', '2015-05-08 13:27:57', '2015-05-08 13:27:57'),
(19, 3, 4, 1, 'dwad', 'dwadaw', '1992-05-13', 2013, 2015, '3.00', 1, 0, 0, '99811042', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 1, 'dwda@gust.edu.kw', 'Uu47h1Uq_TS-8juPZo1ScpU4mWAc0YEE', '$2y$13$9GbGFaawgypMjF5176WSFuMDrPyPhzFv45VguoUXHobdIFqOwV6/O', '', 'en-US', 0, '', '2015-05-08 13:30:03', '2015-05-08 13:30:03', '2015-05-08 13:30:03'),
(20, 2, 84, 1, 'Khalud', 'Mutawa', '1996-05-15', 2015, 2020, '3.00', 2, 1, 1, '99811042', 'y32jrhn4 r43r 43r34r43r\r\n43\r\n3r4\r\n4', NULL, NULL, NULL, NULL, 'sports,anime,photo', 'jjbxmw', NULL, NULL, NULL, 1, 1, NULL, 1, 'fef@gust.edu.kw', 'QRp3PepAAMgroFuVTZpWp4cJpeNW7dNQ', '$2y$13$dhDYhtnoOsdXC481zafvDOStg0iKpPHkA5dzQDPRnvFfy4rQyP5Fy', '', 'en-US', 0, '', '2015-05-08 14:27:12', '2015-05-08 14:27:36', '2015-05-08 14:27:12'),
(21, 3, 84, 1, 'dwad', 'dwadaw', '1983-05-25', 2012, 2019, '3.00', 0, 1, 1, '99811042', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 1, 'dwad@gust.edu.kw', '-whht11kwdthW2QSz1mpYpNhL0UAl0fk', '$2y$13$IFQoZhYp0UkaCTg6/meiYu4fGyNXP37t20.F0vczQyuZKSAdn1RGa', '', 'en-US', 0, '', '2015-05-27 19:38:24', '2015-05-27 19:38:24', '2015-05-27 19:38:24'),
(22, 2, 84, 1, 'Khalid', 'Mutawa', '1990-05-23', 2015, 2016, '2.00', 2, 1, 1, '99811042', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 2, 'dwafd@gust.edu.kw', '4kXPBtwcy1CL-eGkRTX8oAaLWKFTX3A-', '$2y$13$WA3nrQ5u3MuZ3w06T./equ1sPLhY6nKX3eKOG/i/wBo/lMfY4e8Vy', '', 'en-US', 0, '', '2015-05-29 09:51:39', '2015-05-29 10:11:37', '2015-05-29 09:51:39'),
(23, 2, 5, 2, 'Khalid', 'Mutawa', '1986-06-11', 2013, 2017, '3.00', 2, 1, 1, '99811042', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2HLMXQHbHxnCpo7gFfnJLS5OQ--QAPpQ.jpg', 0, 0, NULL, 2, 'dwadwad@dwad.com', '-1M2-Us1yTuBsDM8TcqqLiJyWWXKgkTX', '$2y$13$WYd8zzkfvnsJJajvD9mdf.wcx2eSjkHffsJ8gGR2lzmvAjFb3KvyS', '', 'en-US', 0, '', '2015-06-28 15:26:29', '2015-06-28 15:26:29', '2015-06-28 15:26:29'),
(24, 3, 84, 1, 'Km', 'Km', '1988-07-15', 2012, 2017, '3.00', 2, 1, 1, '99811042', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 1, 'dwadaww@gust.edu.kw', '4WNOEHWwMs8S0MLBlyLL-NYslRWDedlX', '$2y$13$OEAfWylmHxG6SgLz4THIM.l.cRLVjPf/B1hCY3BN0MAWkqJ2Bg/gS', '', 'en-US', 0, '', '2015-07-14 21:07:24', '2015-07-14 21:07:24', '2015-07-14 21:07:24');
...
(50, 13, 14, NULL, 'ters', 0, 0, '2015-07-08 14:58:28'),
(51, 13, 15, 'gfgncbv ', 'ghjnvb', 0, 0, '2015-07-08 14:58:34');
...
--
-- Indexes for table `cybersource_payment`
--
ALTER TABLE `cybersource_payment`
  ADD PRIMARY KEY (`payment_id`), ADD KEY `employer_id` (`employer_id`), ADD KEY `job_id` (`job_id`), ADD KEY `payment_track_uuid` (`payment_track_uuid`);
...
--
-- AUTO_INCREMENT for table `cybersource_payment`
--
ALTER TABLE `cybersource_payment`
  MODIFY `payment_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `filter`
  MODIFY `filter_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `job`
  MODIFY `job_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=27;
--
...
--
ALTER TABLE `job_process_queue`
  MODIFY `queue_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `notification_employer`
  MODIFY `notification_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=56;
--
...
--
ALTER TABLE `student`
  MODIFY `student_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `student_job_application`
--
ALTER TABLE `student_job_application`
  MODIFY `application_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=52;
--
...
--
-- Constraints for table `cybersource_payment`
--
ALTER TABLE `cybersource_payment`
ADD CONSTRAINT `cybersource_payment_ibfk_1` FOREIGN KEY (`employer_id`) REFERENCES `employer` (`employer_id`),
ADD CONSTRAINT `cybersource_payment_ibfk_2` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`);
